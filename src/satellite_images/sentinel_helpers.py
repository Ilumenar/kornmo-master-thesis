# This file is copied from the github of the previous work done on this project
...
CLIENT_ID = '67f0c9a1-031a-4891-b8fa-bd5e0c9288a7'
CLIENT_SECRET = 'U(wx]lGNH2ity^AY5-RjM4J5}#M]#t?K(icEAm-_'
...
def download_timeseries_from_polygon(polygon: Polygon, start, end, num, evalscript=true_color, maxcc=None, size=None,
                                     resolution=None):
    slots = create_slots(start, end, num)
...
def download_image_series(slots, evalscript=true_color, maxcc=None, size=None, bbox=None, polygon=None):
    ...
    imgs = SentinelHubDownloadClient(config=config).download(list_of_requests)
